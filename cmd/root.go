...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&dataFile, "datafile", home+string(os.PathSeparator)+"Desktop"+string(os.PathSeparator)+"go"+string(os.PathSeparator)+"tri"+string(os.PathSeparator)+"tridos.json", "data file to store todos")
